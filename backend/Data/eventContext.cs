...
protected override void OnModelCreating(ModelBuilder modelBuilder)
{
    var event1 = new Event
    {
        ...
        StartTime = DateTime.Parse("2024-01-19T16:00:00.000Z").ToLocalTime(),
        Duration = 2,
    ...
    var event2 = new Event
    {
        ...
        StartTime = DateTime.Parse("2024-01-20T08:00:00.000Z").ToLocalTime(),
        Duration = 2,
    ...
    var event3 = new Event
    {
        ...
        StartTime = DateTime.Parse("2024-01-20T15:30:00.000Z").ToLocalTime(),
        Duration = 2,
    ...
    var event4 = new Event
    {
        ...
        StartTime = DateTime.Parse("2024-01-21T10:00:00.000Z").ToLocalTime(),
        Duration = 2,
